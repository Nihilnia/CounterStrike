...
| `annotation_append` | cmd | cl, release | Load annotation to a file without clearing existing annotations |
| `annotation_auto_load` | false | cl, release | |
| `annotation_clear` | cmd | cl, release | Clear all annotation |
| `annotation_create` | cmd | cl, release | Creates an annotation |
| `annotation_delete_previous_node_set` | cmd | cl, release | Delete the last node set created |
| `annotation_load` | cmd | cl, release | Load annotation to a file after first clearing existing annotations |
| `annotation_reload` | cmd | cl, release | Reload the annotation file |
| `annotation_reload_language_file` | cmd | cl, release | Creates an annotation |
| `annotation_save` | cmd | cl, release | Save annotation to a file |
| `autobuy` | cmd | cl, clientcmd_can_execute | Attempt to purchase items with the order listed in cl_autobuy |
...
| `bot_allow_grenades` | true | sv, release | If nonzero, bots may use grenades. |
| `bot_allow_machine_guns` | true | sv, release | If nonzero, bots may use the machine gun. |
| `bot_allow_pistols` | true | sv, release | If nonzero, bots may use pistols. |
| `bot_allow_rifles` | true | sv, release | If nonzero, bots may use rifles. |
| `bot_allow_rogues` | true | sv, release | If nonzero, bots may occasionally go 'rogue'. Rogue bots do not obey radio commands, nor pursue scenario goals. |
| `bot_allow_shotguns` | true | sv, release | If nonzero, bots may use shotguns. |
| `bot_allow_snipers` | true | sv, release | If nonzero, bots may use sniper rifles. |
| `bot_allow_sub_machine_guns` | true | sv, release | If nonzero, bots may use sub-machine guns. |
| `bot_auto_follow` | false | sv, release | If nonzero, bots with high co-op may automatically follow a nearby human player. |
| `bot_auto_vacate` | true | sv, release | If nonzero, bots will automatically leave to make room for human players. |
...
| `bot_chatter` | normal | sv, release | Control how bots talk. Allowed values: 'off', 'radio', 'minimal', or 'normal'. |
| `bot_controllable` | true | sv, release | Determines whether bots can be controlled by players |
...
| `bot_debug` | 0 | sv, cheat | For internal testing purposes. |
| `bot_debug_target` | 0 | sv, cheat | For internal testing purposes. |
| `bot_defer_to_human_goals` | true | sv, release | If nonzero and there is a human on the team, the bots will not do the scenario tasks. |
| `bot_defer_to_human_items` | true | sv, release | If nonzero and there is a human on the team, the bots will not get scenario items. |
| `bot_difficulty` | 2 | sv, release | Defines the skill of bots joining the game. Values are: 0=easy, 1=normal, 2=hard, 3=expert. |
| `bot_dont_shoot` | false | sv, cheat, release | If nonzero, bots will not fire weapons (for debugging). |
| `bot_eco_limit` | 2000 | sv, release | If nonzero, bots will not buy if their money falls below this amount. |
| `bot_flipout` | false | sv, release | If nonzero, bots use no CPU for AI. Instead, they run around randomly. |
...
| `bot_ignore_enemies` | false | sv, cheat | If nonzero, bots will ignore enemies (for debugging). |
| `bot_ignore_players` | false | sv, cheat | Bots will not see non-bot players. |
| `bot_join_after_player` | true | sv, release | If nonzero, bots wait until a player joins before entering the game. |
| `bot_join_team` | any | sv, release | Determines the team bots will join into. Allowed values: 'any', 'T', or 'CT'. |
...
| `bot_prefix` | 0 | sv, release | This string is prefixed to the name of all bots that join the game. `<difficulty>` will be replaced with the bot's difficulty. `<weaponclass>` will be replaced with the bot's desired weapon class. `<skill>` will be replaced with a 0-100 representation of the bot's skill. |
| `bot_quota` | 10 | sv, release | Determines the total number of bots in the game. |
| `bot_quota_mode` | fill | sv, release | Determines the type of quota. Allowed values: 'normal', 'fill', and 'match'. If 'fill', the server will adjust bots to keep N players in the game, where N is bot_quota. If 'match', the server will maintain a 1:N ratio of humans to bots, where N is bot_quota. |
...
| `bot_show_nav` | false | sv, cheat | For internal testing purposes. |
...
| `bot_stop` | 0 | sv, cheat | `bot_stop <1\|all> \| <not_bomber> \| <t> \| <ct>` |
| `bot_traceview` | 0 | sv, cheat | For internal testing purposes. |
| `bot_walk` | false | sv, release | If nonzero, bots can only walk, not run. |
| `bot_zombie` | false | sv, cheat | If nonzero, bots will stay in idle mode and not attack. |
...
| `cl_allow_animated_avatars` | false | cl, a, release | Whether or not to allow animated avatars |
...
| `cl_avatar_convert_png` | cmd | cl, cheat, release | Converts all rgb avatars in the avatars directory to png |
| `cl_avatar_convert_rgb` | cmd | cl, cheat, release | Converts all png avatars in the avatars directory to rgb |
...
| `cl_color` | 3 | cl, a, user | Preferred teammate color |
...
| `cl_crosshair_drawoutline` | false | cl, a, per_user | Draws a black outline around the crosshair for better visibility |
| `cl_crosshair_dynamic_maxdist_splitratio` | 0 | cl, a, per_user | If using cl_crosshairstyle 2, this is the ratio used to determine how long the inner and outer xhair pips will be. [inner = cl_crosshairsize*(1-cl_crosshair_dynamic_maxdist_splitratio), outer = cl_crosshairsize*cl_crosshair_dynamic_maxdist_splitratio] [0 - 1] |
...
| `cl_crosshair_dynamic_splitalpha_outermod` | 0.3 | cl, a, per_user | If using cl_crosshairstyle 2, this is the alpha modification that will be used for the OUTER crosshair pips once they've split. [0.3 - 1] |
| `cl_crosshair_dynamic_splitdist` | 5 | cl, a, per_user | If using cl_crosshairstyle 2, this is the distance that the crosshair pips will split into 2. (default is 7) |
| `cl_crosshair_friendly_warning` | 0 | cl, a, release | 0: off, 1: on |
| `cl_crosshair_outlinethickness` | 0 | cl, a, per_user | Set how thick you want your crosshair outline to draw (0-3) |
...
| `cl_crosshair_t` | false | cl, a, per_user | T style crosshair |
...
| `cl_crosshairgap` | 0 | cl, a, per_user | |
| `cl_crosshairgap_useweaponvalue` | false | cl, a, per_user | If set to 1, the gap will update dynamically based on which weapon is currently equipped |
| `cl_crosshairsize` | 0 | cl, a, per_user | |
| `cl_crosshairstyle` | 4 | cl, a, per_user | 0 = DEFAULT (DISABLED), 1 = DEFAULT STATIC (DISABLED), 2 = DEFAULT (accurate recoil/spread feedback with a fixed inner part), 3 = ACCURATE DYNAMIC (DISABLED) (accurate recoil/spread feedback), 4 = DEFAULT STATIC, 5 = LEGACY (fake recoil - inaccurate feedback) |
| `cl_crosshairthickness` | 2.5 | cl, a, per_user | |
...
| `cl_deathnotices_show_numbers` | 0 | cl, release | 0: default; 1: draw names as just numbers; 2: append number on killer and victim to the name |
...
| `cl_demo_predict` | 1 | cl, release | Enable 'TrueView' when watching a demo, which attempts to recreate the client's experience more accurately. 0=disable, 1=only if demo version match, 2=always |
...
| `cl_dm_buyrandomweapons` | false | cl, a, release | Player will automatically receive a random weapon on spawn in deathmatch if this is set to 1 (otherwise, they will receive the last weapon) |
...
| `cl_fixedcrosshairgap` | 0 | cl, a, per_user | For crosshair style 1: How big to make the gap between the pips in the fixed crosshair |
| `cl_flushentitypacket` | 0 | cheat | For debugging. Force the engine to flush an entity packet. |
| `cl_force_spec_hud_color_to_team` | true | cl, a | Spec hud color setting is always team/teammate |
...
| `cl_graphics_driver_warning_dont_show_again` | false | cl, a, release | Graphics driver recommendation (NVIDIA 581.80 / AMD 23.11.1) |
| `cl_grenadecrosshair_decoy` | true | cl, a, per_user | Is the grenade crosshair enabled |
| `cl_grenadecrosshair_explosive` | true | cl, a, per_user | Is the grenade crosshair enabled |
| `cl_grenadecrosshair_fire` | true | cl, a, per_user | Is the grenade crosshair enabled |
| `cl_grenadecrosshair_flash` | true | cl, a, per_user | Is the grenade crosshair enabled |
| `cl_grenadecrosshair_keepusercrosshair` | true | cl, a, per_user | Keep the user's crosshair when the grenade crosshair is enabled |
| `cl_grenadecrosshair_smoke` | true | cl, a, per_user | Is the grenade crosshair enabled |
| `cl_grenadecrosshairdelay_decoy` | 2 | cl, a, per_user | How long should the pin be pulled for before showing the grenade crosshair |
| `cl_grenadecrosshairdelay_explosive` | 2 | cl, a, per_user | How long should the pin be pulled for before showing the grenade crosshair |
| `cl_grenadecrosshairdelay_fire` | 2 | cl, a, per_user | How long should the pin be pulled for before showing the grenade crosshair |
| `cl_grenadecrosshairdelay_flash` | 2 | cl, a, per_user | How long should the pin be pulled for before showing the grenade crosshair |
| `cl_grenadecrosshairdelay_smoke` | 2 | cl, a, per_user | How long should the pin be pulled for before showing the grenade crosshair |
...
| `cl_hud_color` | 6 | cl, a, release | 0 = team color, 1 = white, 2 = bright white, 3 = light blue, 4 = blue, 5 = purple, 6 = red, 7 = orange, 8 = yellow, 9 = green, 10 = aqua, 11 = pink, 12 = teammate color. |
| `cl_hud_radar_background_alpha` | 1 | cl, a, release | |
| `cl_hud_radar_blur_background` | false | cl, a, release | Blurs the radar background. |
| `cl_hud_radar_map_additive` | true | cl, a, release | Blend Hud radar map additively on top of background. |
| `cl_hud_radar_scale` | 1.1 | cl, a, release | |
| `cl_hud_telemetry_frametime_poor` | 100 | cl, a, release | Frame time greater than this is considered 'poor'. |
| `cl_hud_telemetry_frametime_show` | 2 | cl, a, release | Show frame time (FPS) in the HUD. 0=never, 1=only if poor, 2=always |
...
| `cl_hud_telemetry_net_misdelivery_poor` | 5 | cl, a, release | Packet delivery anomaly rate (0..100) higher than this is considered 'poor'. |
| `cl_hud_telemetry_net_misdelivery_show` | 2 | cl, a, release | Show percentage of user commands & server snapshots that are missed due to network conditions. 0=never, 1=only in poor conditions, 2=always |
...
| `cl_hud_telemetry_ping_show` | 2 | cl, a, release | Show ping in the HUD. 0=never, 1=only in poor conditions, 2=always |
...
| `cl_interp_ratio` | 0 | cl, user | Set number of client simulation interpolation ticks. |
...
| `cl_ironsight_dot_scale` | 1 | cl, a, per_user | Ironsight dot scale |
| `cl_ironsight_usecrosshaircolor` | true | cl, a, per_user | Should the scope dot match the user's crosshair color |
| `cl_itemimages_dynamically_generated` | 2 | cl, a, release | 2: use render-targets; 0: disk assets only |
| `cl_jitter_bad_threshold_up` | 10 | user | When upstream packet jitter in a frame exceeds this threshold (ms), the frame is considered to have 'irregular delivery'. This is a derived value and should not be modified manually |
...
| `cl_net_buffer_ticks` | 0 | cl, a, release | Number of ticks of delay for server snapshots and user commands. This value controls the value of cl_interp_ratio, which you should not modify directly. |
| `cl_net_buffer_ticks_use_interp` | false | cl, release | If false, we smooth over packet loss by adjusting the clock synchronization to buffer packets. If true, we process packets immediately and use cl_interp to delay their effects |
...
| `cl_obs_interp_speed` | 1 | cl, a | Spectator camera interpolation speed |
...
| `cl_predict_kill_ragdolls` | false | cl, a, release | |
...
| `cl_prefer_lefthanded` | true | cl, a, user, per_user | Left handed preference |
| `cl_promoted_settings_acknowledged` | 1:1613599630404 | cl, a | |
...
| `cl_radar_scale` | 0.3 | cl, a, release | Sets the radar scale. Valid values are 0.25 to 1.0. |
| `cl_radar_scale_alternate` | 1 | cl, a, release | Sets the alternate radar scale. Valid values are 0.25 to 1.0. |
| `cl_radar_scale_dynamic` | false | cl, a, release | Toggles between a radar that scales dynamically to encompass all the detected elements on the map. |
| `cl_radar_square_always` | false | cl, a, release | If set, the radar will always be square. |
| `cl_radar_square_with_scoreboard` | false | cl, a, release | If set, the radar will toggle to square when the scoreboard is visible. |
...
| `cl_redemption_reset_timestamp` | 1764364123 | cl, a, release | |
...
| `cl_scoreboard_survivors_always_on` | true | cl, a, release | |
...
| `cl_show_observer_crosshair` | 2 | cl, a, release | Show the crosshair of the player being observed. 0: off 1: friends and party 2: everyone |
...
| `cl_sniper_show_inaccuracy` | false | cl, a, release | |
...
| `cl_teamid_overhead_colors_show` | true | cl, a, release | Show team overhead id in teammate color |
| `cl_teamid_overhead_fade_near_crosshair` | 0.5 | cl, a, release | The amount to fade teamid when near the crosshair. Range is 0.0-1.0. 0: off |
| `cl_teamid_overhead_maxdist` | 6000 | cl, cheat, per_user | max distance at which the overhead team id icons will show |
| `cl_teamid_overhead_maxdist_spec` | 4000 | cl, cheat, per_user | max distance at which the overhead team id icons will show when a spectator |
| `cl_teamid_overhead_mode` | 3 | cl, a, release | Always show team id over teammates. 0 = off, 1 = pips; 2 = +name, 3 = +equipment |
...
| `cl_track_render_eye_angles` | false | cl, cheat | Spew render eye angles |
| `cl_trueview_show_status` | 2 | cl, release | 0=Never; 1=Only if there is a problem; 2=always |
| `cl_use_last_selected_weapon_slot_position` | false | cl, a, release | Use the last selected weapon slot position when switching back to a weapon slot. |
| `cl_use_opens_buy_menu` | false | cl, a, user, per_user | Pressing the +use key will open the buy menu if in a buy zone (just as if you pressed the 'buy' key). |
| `cl_usercmd_max_per_movemsg` | 4 | release | max number of CUserCmds to send in one client move message |
| `cl_versus_intro` | false | cl, a, release | |
| `cl_viewing_vanity_loadout` | false | sv, cl, user | |
| `cl_vrr_recommendation_dont_show_again` | false | cl, a, release | |
| `cl_wallbang_heavy_threshold` | 22 | cl, cheat, release | The Threshold where to switch from Light to Heavy Wallbang tracer |
...
| `cl_weapon_debug_show_accuracy` | 0 | cl, cheat, release | Draws a circle representing the effective range with every shot. |
| `cl_weapon_debug_show_accuracy_duration` | 10 | cl, cheat, release | |
| `cl_weapon_selection_rarity_color` | true | cl, a, release | |
...
| `contributionscore_assist_reqs` | 1 | sv, release | extra requirements to earn contribution score for an assist |
...
| `contributionscore_kill_reqs` | 1 | sv, release | extra requirements to earn contribution score for a kill |
| `contributionscore_objective_kill` | 3 | sv, release | amount of contribution score added for an objective related kill |
| `contributionscore_participation` | 0 | sv, release | amount of contribution score awarded to players for active participation in the round |
...
| `cq_buffer_bloat_msecs_max` | 64 | rep, release | Server will not allow the client to buffer up more than N ms of commands. |
...
| `cs_minimap_create_output_size` | 1024 | cl, release | Size of minimap texture generated with cs_minimap_create (512 default) |
...
| `csgo_map_preview_scale` | 5.09598 | cl, a | |
| `csgo_use_fullsort_for_opaque` | true | cl, cheat | fullsort the opaque pass when there wasn't a depth prepass |
...
| `demo_highlight_fade_duration` | 0.25 | cl, release | Duration of the fade in and of the fade out transitions (fade in + fade out is 2x this value). |
| `demo_highlight_seconds_after` | 2 | cl, release | How many seconds after the actual highlight event to show when viewing highlights. |
| `demo_highlight_seconds_before` | 6 | cl, release | How many seconds before the actual highlight event to show when viewing highlights. |
...
| `demo_mouse_enable_binding` | drop | cl, a | Name of the binding to enable mouse on demo playback UI |
| `demo_pause` | cmd | release | Pauses demo playback. |
| `demo_pause_at_end` | true | cl, release | Pause demo playback when the end of the file is reached, otherwise quit to main menu. |
...
| `demo_skip_to_shot_seconds_before` | 2 | cl, release | How many seconds before the shot to skip to when skipping to a specific shot ID. |
...
| `demo_ui_mode` | 2 | cl, release | UI mode for demo playback. 0 = disabled, 1 = minimal, 2 = full |
...
| `endmatch_votenextmap` | cmd | cl, clientcmd_can_execute | Votes for the next map at the end of the match |
...
| `fps_max_ui` | 64 | a | Frame rate limiter while the game UI is displayed. 0=no limit. Does not apply to dedicated server. |
...
| `gameinstructor_enable` | false | cl, release | Display in game lessons that teach new players. |
...
| `hostage_debug` | 0 | sv, cl, rep, cheat | Show hostage AI debug information |
| `hostage_is_silent` | false | sv, cl, rep, cheat | When set, the hostage won't play any code driven response rules lines |
| `hostfile` | host.txt | sv, release | The HOST file to load. |
| `hostip` | 0 | release | Host game server ip |
| `hostname` | Nihil | release | Hostname for server. |
...
| `inferno_ct_experiment` | true | sv, cl, rep, cheat | enable ct incendiary experiment |
| `inferno_damage` | 40 | sv, cheat | Damage per second |
| `inferno_damage_ct` | 40 | sv, cheat | Damage per second from CT inferno |
| `inferno_debug` | false | sv, cheat | |
| `inferno_dlight_spacing` | 7200 | cl, cheat | Inferno dlights are at least this far apart |
| `inferno_flame_lifetime` | 7 | sv, rep, release | Average lifetime of each flame in seconds |
| `inferno_flame_lifetime_incendiary` | 5.5 | sv, rep, release | Average lifetime of each flame in seconds (incgrenade) |
...
| `inferno_max_range_ct` | 110 | sv, rep, release | Maximum distance flames can spread from their initial ignition point for an incendiary |
...
| `inferno_spread_speed_mult` | 1 | sv, rep, release | Speed up the spreadrate of the Molotov until max number of nodes are created. slowdown < 1 > Speedup |
| `inferno_spread_speed_mult_ct` | 10 | sv, rep, release | Speed up the spread rate of the Incendiary until max number of nodes are created. slowdown < 1 > Speedup |
...
| `install_dlc_workshoptools_cvar` | 0 | cl, release | DLC Install Status |
...
| `lb_barnlight_shadowmap_scale` | 0.5 | release | Scale for computed barnlight shadowmap size |
...
| `lobby_default_privacy_bits2` | 1 | cl, a, release | Lobby default permissions (0: private, 1: public) |
...
| `logaddress_del_http` | cmd | sv, nolog, release | Remove http listener by URI. Wrap URI in double quotes. |
...
| `map_workshop` | cmd | cl, release, vconsole_fuzzy, vconsole_set_focus | Launch a workshop map |
...
| `mm_dedicated_search_maxping` | 80 | a | Longest preferred ping to dedicated servers for games |
...
| `mp_buy_allow_guns` | 255 | sv, cl, rep, release | Whether players can purchase guns: pistols (1), SMGs (2), rifles (4), shotguns (8), sniper rifles (16), heavy MGs (32). |
...
| `mp_consecutive_loss_aversion` | 1 | sv, cl, rep, release | How loss streak is affected with round win: 0 = win fully resets loss bonus, 1 = first win steps down loss bonus, 2 = first win holds loss bonus and step down starting with second win |
...
| `mp_ct_default_grenades` | 0 | sv, cl, rep, release | The default grenades that the CTs will spawn with. To give multiple grenades, separate each weapon class with a space like this: 'weapon_molotov weapon_hegrenade' |
| `mp_ct_default_melee` | weapon_knife | sv, cl, rep, release | The default melee weapon that the CTs will spawn with. Even if this is blank, a knife will be given. To give a taser, it should look like this: 'weapon_knife weapon_taser'. Remember to set mp_weapons_allow_zeus to 1 if you want to give a taser! |
...
| `mp_damage_headshot_only` | false | sv, cl, rep, release | Determines whether non-headshot hits do any damage. |
| `mp_damage_scale_ct_body` | 1 | sv, cl, rep, release | Scales the damage a CT player takes by this much when they take damage in the body. (1 == 100%, 0.5 == 50%) |
| `mp_damage_scale_ct_head` | 1 | sv, cl, rep, release | Scales the damage a CT player takes by this much when they take damage in the head (1 == 100%, 0.5 == 50%). REMEMBER! headshots do 4x the damage of the body before this scaler is applied. |
| `mp_damage_scale_t_body` | 1 | sv, cl, rep, release | Scales the damage a T player takes by this much when they take damage in the body. (1 == 100%, 0.5 == 50%) |
| `mp_damage_scale_t_head` | 1 | sv, cl, rep, release | Scales the damage a T player takes by this much when they take damage in the head (1 == 100%, 0.5 == 50%). REMEMBER! headshots do 4x the damage of the body before this scaler is applied. |
...
| `mp_death_drop_grenade` | 2 | sv, cl, rep, release | Which grenade to drop on player death: 0=none, 1=best, 2=current or best, 3=all grenades |
| `mp_death_drop_gun` | 1 | sv, cl, rep, release | Which gun to drop on player death: 0=none, 1=best, 2=current or best |
...
| `mp_defuser_allocation` | 0 | sv, cl, rep, release | How to allocate defusers to CTs at start or round: 0=none, 1=random, 2=everyone |
...
| `mp_dm_bonus_length_max` | 30 | sv, cl, rep, release | Maximum time the bonus time will last (in seconds) |
| `mp_dm_bonus_length_min` | 30 | sv, cl, rep, release | Minimum time the bonus time will last (in seconds) |
...
| `mp_dm_healthshot_killcount` | 3 | sv, cl, rep, release | Grant healthshots in deathmatch after n kills |
...
| `mp_dm_taser_bonus_streak_max` | 2 | sv, cl, rep, release | Maximum times to multiply the score for getting a streak of taser kills in a single life. |
| `mp_dm_teammode` | 0 | sv, cl, rep, release | In deathmatch, enables team DM visuals & scoring (0: personal, 1: team mode, 2: use team contribution score) |
...
| `mp_dm_time_between_bonus_max` | 40 | sv, cl, rep, release | Maximum time a bonus time will start after the round start or after the last bonus (in seconds) |
| `mp_dm_time_between_bonus_min` | 30 | sv, cl, rep, release | Minimum time a bonus time will start after the round start or after the last bonus (in seconds) |
...
| `mp_drop_grenade_enable` | true | sv, cl, rep, release | Allows players to drop grenades. |
| `mp_drop_knife_enable` | false | sv, cl, rep, release | Allows players to drop knives. |
...
| `mp_modify_timeouts` | cmd | sv, release | `mp_modify_timeouts <CT\|T> <N>`, e.g., mp_modify ct -1 |
...
| `mp_overtime_limit` | 0 | sv, cl, rep, release | When overtime is enabled, only so many overtimes can be played |
...
| `mp_playerid` | 0 | sv, cl, rep, release | Controls what information player see in the status bar: 0 all names; 1 team names; 2 no names |
...
| `mp_promoted_item_enabled` | false | sv, cl, nf, rep, release | Allow the purchasing of the promoted item. |
...
| `mp_retake_ct_loadout_bonus_card` | #GameUI_Retake_Card_TheAWPortunity,1,1,weapon_awp | sv, cl, rep, release | CT bonus card for full buy round when playing bomb site retake. |
...
| `mp_retake_ct_loadout_default_pistol_round` | 1\|3;#GameUI_Retake_Card_4v3,1,0,secondary0\|1;#GameUI_Retake_Card_FlashOut,0,0,secondary0,grenade0;#GameUI_Retake_Card_HideAndPeek,0,0,secondary0,grenade1 | sv, cl, rep, release | CT Loadouts for default pistol round when playing bomb site retake. |
...
| `mp_retake_ct_loadout_full_buy_round` | 4\|2;#GameUI_Retake_Card_LightEmUp,1,1,rifle1,grenade0\|2;#GameUI_Retake_Card_Kobe,1,1,rifle1,grenade2\|1;#GameUI_Retake_Card_1g,1,1,rifle1,grenade3\|1;#GameUI_Retake_Card_DisappearingAct,1,1,rifle1,grenade1\|1;#GameUI_Retake_Card_EyesOnTarget,1,1,weapon_aug | sv, cl, rep, release | CT Loadouts for full buy round when playing bomb site retake. |
| `mp_retake_ct_loadout_light_buy_round` | 3\|2;#GameUI_Retake_Card_UmpInSmoke,1,1,weapon_ump45,grenade1\|2;#GameUI_Retake_Card_FunNGun,1,1,weapon_mp9,grenade2\|2;#GameUI_Retake_Card_Sharpshooter,1,1,weapon_ssg08,grenade0\|2;#GameUI_Retake_Card_BurstBullpup,1,1,weapon_famas | sv, cl, rep, release | CT Loadouts for force buy round when playing bomb site retake. |
| `mp_retake_ct_loadout_upgraded_pistol_round` | 2\|2;#GameUI_Retake_Card_TakeFive,0,0,weapon_fiveseven\|2;#GameUI_Retake_Card_BlindFire,1,0,weapon_p250,grenade0\|2;#GameUI_Retake_Card_OnlyTakesOne,0,0,weapon_deagle\|2;#GameUI_Retake_Card_SneakyBeakyLike,0,0,weapon_p250,grenade1 | sv, cl, rep, release | CT Loadouts for upgraded pistol round when playing bomb site retake. |
...
| `mp_retake_t_loadout_bonus_card` | #GameUI_Retake_Card_TheAWPortunity,1,1,weapon_awp | sv, cl, rep, release | T bonus card for full buy round when playing bomb site retake. |
...
| `mp_retake_t_loadout_default_pistol_round` | 0\|3;#GameUI_Retake_Card_4BadGuysLeft,1,0,secondary0\|1;#GameUI_Retake_Card_LookAway,0,0,secondary0,grenade0;#GameUI_Retake_Card_WhenThereIsSmoke,0,0,secondary0,grenade1 | sv, cl, rep, release | T Loadouts for default pistol round when playing bomb site retake. |
| `mp_retake_t_loadout_enemy_card` | #GameUI_Retake_Card_FindersKeepers,1,1,rifle1,grenade0 | sv, cl, rep, release | T enemy card for full buy round when playing bomb site retake. |
| `mp_retake_t_loadout_full_buy_round` | 0\|2;#GameUI_Retake_Card_OlReliable,1,1,rifle1,grenade0\|1;#GameUI_Retake_Card_SmokeShow,1,1,rifle1,grenade1\|1;#GameUI_Retake_Card_HotShot,1,1,rifle1,grenade3\|1;#GameUI_Retake_Card_EyeSpy,1,1,weapon_sg556,grenade2 | sv, cl, rep, release | T Loadouts for full buy round when playing bomb site retake. |
| `mp_retake_t_loadout_light_buy_round` | 0\|2;#GameUI_Retake_Card_BackInAFlash,1,1,weapon_ump45,grenade0\|2;#GameUI_Retake_Card_AllIn,1,1,weapon_galilar\|1;#GameUI_Retake_Card_BoomBox,1,1,weapon_mac10,grenade2,grenade1\|1;#GameUI_Retake_Card_SetThemFree,1,1,weapon_ssg08,grenade0 | sv, cl, rep, release | T Loadouts for force buy round when playing bomb site retake. |
| `mp_retake_t_loadout_upgraded_pistol_round` | 0\|2;#GameUI_Retake_Card_BlindFire,1,0,weapon_elite,grenade0\|2;#GameUI_Retake_Card_QueOta,0,0,weapon_deagle\|1;#GameUI_Retake_Card_SmokeScreen,0,0,weapon_p250,grenade1\|1;#GameUI_Retake_Card_TecTecBoom,0,0,weapon_tec9,grenade2 | sv, cl, rep, release | T Loadouts for upgraded pistol round when playing bomb site retake. |
...
| `mp_solid_enemies` | 1 | sv, cl, rep, release | How solid are enemies: 0 = transparent; 1 = fully solid |
| `mp_solid_teammates` | 1 | sv, cl, rep, release | How solid are teammates: 0 = transparent; 1 = fully solid; 2 = can stand on top of heads |
...
| `mp_starting_losses` | 1 | sv, cl, rep, release | Determines what the initial loss streak is. |
...
| `mp_t_default_grenades` | 0 | sv, cl, rep, release | The default grenades that the Ts will spawn with. To give multiple grenades, separate each weapon class with a space like this: 'weapon_molotov weapon_hegrenade' |
...
| `mp_tagging_scale` | 1 | sv, cl, rep, release | Scalar for player tagging modifier when hit. Lower values for greater tagging. |
| `mp_taser_recharge_time` | 30 | sv, cl, rep, release | Determines recharge time for taser. -1 = disabled. |
...
| `mp_team_timeout_ot_add_each` | 0 | sv, cl, rep, release | Number of timeouts to add for each team when match goes to 2nd and each next overtime. |
| `mp_team_timeout_ot_add_once` | 0 | sv, cl, rep, release | Number of timeouts to add for each team when regulation time ends and match goes to overtime. |
| `mp_team_timeout_ot_max` | 1 | sv, cl, rep, release | Max number of timeouts each team can have per OT after all OT timeouts got added. |
...
| `mp_warmup_items_drop_policy` | 247 | sv, cl, rep, release | Which items can drop during warmup (bitfield, 1=gun, 2=c4, 4=nade, 8=defuser, 16=taser, 32=healthshot) |
| `mp_warmup_items_nocost` | false | sv, cl, rep, release | Determines whether weapons are free to buy during warmup. |
| `mp_warmup_items_nocount_policy` | 42 | sv, cl, rep, release | Which items are unlimited during warmup (bitfield, 1=gun, 2=c4, 4=nade, 8=defuser/kevlar, 16=taser, 32=healthshot) |
...
| `mp_warmuptime` | 120 | sv, cl, rep, release | How long the warmup period lasts. Changing this value resets warmup. |
| `mp_warmuptime_all_players_connected` | 15 | sv, cl, rep, release | Warmup time to use when all players have connected. 0 to disable. |
| `mp_warmuptime_match_cancelled` | 5 | sv, cl, rep, release | Warmup time to use when the match will be cancelled (eg. due to a live VAC ban). |
...
325 convars/concommands for [n]

| Command | Default Value | Flags | Description |
| :--- | :--- | :--- | :--- |
| `name` | Nihil | a, per_user | |
...
| `nav_disconnect` | cmd | sv, cheat | Disconnects selected area from all neighbor areas. |
...
| `nav_gen_agent_radius_buffer` | 0.75 | sv, cheat | Buffer to add to agent radius before passing to nav gen |
...
| `nav_gen_jump_connection_min_overlap_ratio` | 0.1 | sv, cheat | Minimum edge overlap required for jump connection consideration as a percentage of agent radius |
...
| `nav_navlink_enable_splits` | true | sv, cheat | Split wide nav links into narrower ones to increase lanes and alleviate 'crossing' effect. |
| `nav_navlink_split_max_width` | 144 | sv, cheat | The maximum desired width of a nav link split. |
| `nav_navlink_split_scale_with_length` | true | sv, cheat | Nav link splits' widths are proportional to the nav link's length. |
...
| `password` | nq93bd | a, norecord, server_cant_query | Current server access password |
...
| `player_competitive_maplist_2v2_10_0_BCB8668D` | mg_de_inferno | cl, a | |
| `player_competitive_maplist_8_10_0_C951FF02` | mg_de_dust2,mg_de_mirage,mg_de_inferno,mg_de_ancient,mg_de_nuke,mg_de_train,mg_de_overpass,mg_de_anubis,mg_de_vertigo,mg_de_palacio,mg_de_golden,mg_cs_agency,mg_cs_office,mg_cs_italy | cl, a | |
...
| `r_drawtracers_firstperson` | false | cl, a, release | Toggle visibility of first person weapon tracers |
...
| `r_fullscreen_gamma` | 3.5 | a | Screen Gamma (only in fullscreen modes) |
...
| `r_show_build_info` | false | cl, a, release | Build information. Leave this enabled when submitting bug screenshots and videos, please! |
| `r_show_time_info` | false | cl, release | Show real time, large. |
...
| `radio` | cmd | cl, release | Opens a radio menu |
| `radio1` | cmd | cl, release | Opens a radio menu |
| `radio2` | cmd | cl, release | Opens a radio menu |
| `radio3` | cmd | cl, release | Opens a radio menu |
...
| `rate` | 1000000 | a, user | Min bytes/sec the host can receive data |
...
| `replay_start` | cmd | sv, cheat | Start Source2 TV replay: replay_start `<delay> [<player name or index>]` |
...
| `safezoney` | 0.99 | cl, a | The percentage of the screen height that is considered safe from overscan |
...
| `sellbackall` | cmd | cl, clientcmd_can_execute | Attempt to refund all equipment |
| `sensitivity` | 1.3 | cl, a, user, per_user | Mouse sensitivity. |
...
| `snd_deathcamera_volume` | 0 | cl, a, release | Volume of Deathcam Timers |
...
| `snd_headphone_eq_active` | 0 | cl, clientcmd_can_execute | Select Headphone EQ Preset |
| `snd_list` | 0 | cheat | |
...
| `snd_mapobjective_volume` | 0 | cl, a, release | Volume of Map Objective Music |
| `snd_menumap_volume` | 1 | cl, a, release | Volume of background sounds for maps |
| `snd_menumusic_volume` | 0 | cl, a, release | Volume of Menu / Non-gameplay music |
...
| `snd_mvp_volume` | 0 | cl, a, release | Volume of MVP Music |
...
| `snd_refresh_ui_audio_state` | cmd | cl, cheat | Restores audio DSP state for the UI. |
...
| `snd_roundend_volume` | 0 | cl, a, release | Volume of Won/Lost Music |
...
| `snd_spatialize_lerp` | 0.304747 | a, release | |
...
| `snd_steamaudio_enable_pathing` | true | cheat | This variable is checked by soundstack to globally enabling pathing for audio processing. |
...
| `snd_surf_volume_inair` | 0.5 | cl, a, release | The volume of the wind when surfing. |
| `snd_surf_volume_map` | 0.3 | cl, a, release | The volume of ambient sounds when surfing is enabled. |
| `snd_surf_volume_slide` | 0.5 | cl, a, release | The volume of sliding along surfaces when surfing. |
| `snd_tensecondwarning_volume` | 0 | cl, a, release | Volume of Ten Second Warnings |
...
| `sound_device_override` | {0.0.0.00000000}.{87871754-60e5-49e7-9bd2-ce778c31843c} | a, release | ID of the sound device to use |
...
| `spec_goto` | cmd | cl, clientcmd_can_execute | Move the spectator camera to a specific location. `spec_goto x y z pitch yaw` |
...
| `spec_show_xray` | 0 | cl, a, release | If set to 1, you can see player outlines and name IDs through walls - who you can see depends on your team and mode |
...
| `surf_speed_fast` | 3000 | sv, cl, rep, release | Speed above which a player is considered to be going fast. |
| `surf_speed_med` | 2000 | sv, cl, rep, release | Speed above which a player is considered to be going medium. |
| `surf_speed_slow` | 50 | sv, cl, rep, release | Speed above which a player is considered to be going slow. |
...
| `suspicious_hit_strategy` | 0 | sv, release | What to do about suspicious hits. 0: Nothing. 1: Skip the bullet. 2: Skip the bullet and re-roll a new bullet. |
...
| `sv_allow_annotations` | false | sv, cl, rep, release | Allow clients to use the annotation system on the server. |
...
| `sv_auto_cstrafe_attempt_window` | 1 | sv, release | The length of the window of trailing counter-strafe attempts considered during input automation detection. |
| `sv_auto_cstrafe_kick` | false | sv, release | Whether or not to kick players when counter-strafe input automation is detected. |
| `sv_auto_cstrafe_logging` | 0 | sv, release | 0: never, 1: every time counter-strafe input automation is detected, 2: every counter-strafe |
| `sv_auto_cstrafe_lower_overlap_pct_threshold` | 0 | sv, release | The percentage of overlapping attempts in the attempt window below which input automation detection is triggered at the success threshold. |
| `sv_auto_cstrafe_min_attempts` | 1 | sv, release | The minimum number of counter-strafe attempts required for input automation detection. The player must be moving more than 135.2 units/s for their counter-strafe to be considered an attempt. An attempt is either considered a success (counter-strafing took place within a single tick), an overlap (both directions were held for 1+ ticks) or an underlap (neither direction was held for 1+ ticks). |
| `sv_auto_cstrafe_sequence_length` | 1 | sv, release | The length of sequential counter-strafe attempts evaluated relative to the success threshold. Input automation detection considers the best sequence within the larger attempt window. |
| `sv_auto_cstrafe_success_threshold` | 1 | sv, release | The minimum number of successful counter-strafes within a best sequence that will trigger input automation detection. The number of successes that trigger input automation detection is interpolated between the success threshold and a 'perfect' sequence (all counter-strafes in a sequence are successes), depending on the player's percentage of overlapping counter-strafe attempts. |
| `sv_auto_cstrafe_upper_overlap_pct_threshold` | 0 | sv, release | The percentage of overlapping attempts in the attempt window below which input automation detection is triggered when all counter-strafes in a sequence are successes. |
...
| `sv_disconnected_players_cleanup_delay` | 0 | sv, release | Delay between player disconnecting and their corpse getting cleaned up. |
...
| `sv_flashed_amount_for_blind_kill` | 0.7 | sv, release | Minimum flashed alpha value for a player to be awarded a blind kill on the kill feed. |
...
| `sv_jump_precision_enable` | true | sv, cl, rep, release | Enable jump precision. Some game modes benefit from being able to turn this off. |
...
| `sv_kill_players_at_coord_min` | true | sv, release | Kill players with fall damage at negative coord min |
...
| `sv_lagcomp_filterbyviewangle` | true | sv, cheat | If true, player pawn will filter lag compensation targets by their view angle. |
...
| `sv_limit_buyrandom_per_life` | true | sv, release | Enable to limit buyrandom command to only run once per player life |
...
| `sv_logfile` | true | a, release | Log server information in the log file. |
...
| `sv_mapvetopickvote_maps` | de_inferno,de_mirage,de_train,de_dust2,de_nuke,de_ancient,de_overpass | sv, release | Which maps are used for map veto pick sequence |
...
| `sv_maxunlag` | 0.2 | sv, cl, rep, release | Maximum lag compensation in seconds |
| `sv_maxunlag_player` | -1 | sv, release | If >0, maximumum lag compensation used for other human pawns. Applied after sv_maxunlag! |
...
| `sv_minimum_desired_chicken_count` | 0 | sv, rep, release | Minimum number of chickens to attempt to spawn in the map |
...
| `sv_predictable_damage_tag_ticks` | 2 | sv, release | Delay player slowdown when damaged by # ticks to reduce misprediction effects |
...
| `sv_quantize_movement_input` | true | sv, cl, rep, release | Quantize movement input values. Enabling this restricts players from using analog input to move at fractional speeds normally impossible with digital button input. |
...
| `sv_reliableavatardata` | false | sv, cl, rep, release | Use server overrides for steam avatars |
...
| `sv_step_move_vel_min` | 64 | sv, cl, rep, cheat | Min velocity for step move. |
...
| `sv_subtick_movement_view_angles` | true | sv, cl, rep, release | Whether or not subtick view angles are taken into account during movement. |
| `sv_surf_sounds` | false | sv, cl, rep, release | Should we try to play sounds for surf? |
...
| `sv_use_hi_pri_context_switch_time` | 1 | sv, cl, rep, release | +use search behaves as though high priority items are usable for this long after they become unusable to avoid players accidentally performing a different action. |
| `sv_use_playercache` | true | sv, cl, rep, cheat | Cache off player bounds for traces. |
...
| `sv_vote_to_changelevel_rndmin` | 0 | sv, rep, release | When non-zero, restricts vote to change level to this many first rounds or minutes of the match (default 0, vote is not disallowed) |
...
| `toggleradarscale` | cmd | cl, release | Toggles the radar scale |
| `trusted_launch` | 1 | cl, a | Trusted launch status |
...
| `ui_inspect_bkgnd_map_539CD0B9` | warehouse | cl, a, release | Inspect background map |
| `ui_inventorysettings_recently_acknowledged` | 0 | cl, a, release | |
| `ui_lobby_draft_enabled` | false | cl, release | |
| `ui_mainmenu_bkgnd_movie_539CD0B9` | de_inferno | cl, a, release | Main menu background movie |
...
| `ui_party_msg_sound_enabled` | true | cl, release | When enabled, lobby messages will play a short sound |
| `ui_playsettings_custom_preset` | mg_de_inferno,mg_de_nuke,mg_de_overpass,mg_de_vertigo | cl, a, release | |
| `ui_playsettings_directchallengekey` | S56JT-9KTN-SM4UL-T2HL | cl, a, release | |
...
| `ui_playsettings_listen_infammo` | 0 | cl, a, release | |
| `ui_playsettings_listen_infwarmup` | 0 | cl, a, release | |
...
| `ui_playsettings_maps_official_casual` | mg_hostage | cl, a, release | |
...
| `ui_setting_advertiseforhire_auto` | 1 | cl, a, release | Whether users will automatically advertise for invites (0: off; 1: last; 2: auto) |
...
| `ui_vanitysetting_loadoutslot_ct` | rifle4 | cl, a, release | |
| `ui_vanitysetting_loadoutslot_t` | rifle4 | cl, a, release | |
...
| `viewmodel_fov` | 68 | cl, a, user, per_user | Viewmodel FOV |
| `viewmodel_offset_x` | 2 | cl, a, user, per_user | viewmodel_offset_x |
| `viewmodel_offset_y` | 2 | cl, a, user, per_user | viewmodel_offset_y |
| `viewmodel_offset_z` | -1 | cl, a, user, per_user | viewmodel_offset_z |
| `viewmodel_presetpos` | 0 | cl, a | 1:'Desktop', 2:'Classic' |
...
| `voice_device_override` | 0 | a, release | Default device used for voice capture. |
| `voice_input_stallout` | 2 | user | Time before we consider a mic stalled out and need to reset it. |
...
| `voice_modenable_toggle` | cmd | cl, release | Toggle the voice_modenable convar. |
| `voice_player_speaking_delay_threshold` | 0.5 | sv, cheat | |
| `voice_test_log_send` | false | release | |
| `voice_threshold` | 0 | cl, a | decibel threshold for how loud the talker's input signal is before we think they are talking. |
| `voice_toggle_open_mic` | cmd | cl, release | Toggles between open-mic and push-to-talk |
...
| `weapon_debug_spread_show` | 0 | cl, cheat, per_user | Enables display of weapon accuracy; 1: show accuracy box, 3: show accuracy with dynamic crosshair |
...
| `workshop_annotation_submit` | cmd | cl, release | Submit annotation to workshop. To update an existing submission add its ID number from the workshop URL as a second argument. |
...
### 0 convars/concommands for [x]

---


### 0 convars/concommands for [y]
